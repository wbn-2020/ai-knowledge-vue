...
async function resetPassword() {
  if (!user.value) return
  const result = await ElMessageBox.prompt('请输入新密码', '重置密码', { inputType: 'password' })
...
<template>
  <div v-loading="loading">
    <div class="page-header"><div><h1 class="page-title">用户详情</h1><div class="page-desc">查看用户基础信息、知识库数量、文档数量和最近登录时间。</div></div></div>
